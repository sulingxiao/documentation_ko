...
sidebar: Ontology_ko
permalink: websocket_api_ko.html
folder: doc_ko/Ontology
giturl: https://github.com/ontio/ontology/blob/master/docs/specifications/websocket_api.md
---
...
[English](./websocket_api_en.html)/한국어
...
You can use the ontology-go-sdk to generate hex code, reference to [example](./rpc_api_en.html#8-sendrawtransaction)
