...
sidebar: Ontology_ko
permalink: install_ko.html
folder: doc_ko/Ontology
giturl: https://github.com/ontio/ontology/blob/master/README.md
---
...
2. run Ontology image
    ...
    - If you need to add Ontology parameters, you can add them directly after `docker run ontio/ontology` such as `docker run ontio/ontology --networkid 2`.
     The parameters of ontology command line refer to [here](./cli_user_guide_en.html).
